...
import PriceAlertPopup from "@/components/PriceAlert";
              ...
              <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-4">
                <div className="mb-4 bg-white px-6 py-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600 mb-4">
                    Choose your subscription type and subscribe for daily
                    updates or set price alerts for each coin:
                  </p>
                  <div className="flex flex-row space-x-2 mb-6">
                    <button
                      onClick={() => handleSubscribe()}
                      className="w-full md:w-[50%] px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md focus:outline-none"
                    >
                      Subscribe for Daily Updates
                    </button>
                    <button
                      onClick={() => handlePriceAlerts()}
                      className="w-full md:w-[50%] mt-2 md:mt-0 md:ml-4 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md focus:outline-none"
                    >
                      Set Price Alerts
                    </button>
                  </div>
                  ...
                  <p className="text-gray-600 mb-4">
                    If you have any older subscription you can remove it from
                    here:
                  </p>
                  <div className="flex flex-col space-y-2 mb-6">
                    ...
                    <button
                      onClick={() => handleRemovePriceAlerts()}
                      className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md focus:outline-none"
                    >
                      Remove Price Alerts
                    </button>
